  ...
  return (
    <div className='w-full flex flex-col justify-center items-center gap-10 mt-10 '>
      {/* headline text */}
        ...
        <h1 className='text-[25px] md:text-[50px] lg:text-[60px] text-white text-center font-semibold  tracking-wide ' id='autoshow'>Redefining how you <span className='text-[#004FFF]'>connect</span> <br /> <span>with the game you love.</span> </h1>
      


      {/* card section */}
      <div className='w-full flex justify-center items-center gap-[80px] lg:justify-around lg:gap-0 flex-col lg:flex-row '>
        {/* card 1 */}
