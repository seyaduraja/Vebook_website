...
function Detail() {
  return (
    ...
    <div  className='container1'>
         <img src= {player} alt="" id='autoshow' className=' h-[200px] w-[350px] md:h-[300px] md:w-[600px] pr-[20px] md:pr-0' />
    ...
    <div className='flex flex-col gap-[20px] w-[350px] md:w-[550px]   '>
         ...
         <img src= {location} alt=""  className=' h-[200px] w-[350px] md:h-[300px] md:w-[600px] ' id='autoshow'/>
    </div>
